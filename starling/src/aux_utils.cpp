...
#pragma omp parallel for schedule(dynamic, 1) num_threads(nthreads)
  ...
  void create_disk_layout(const std::string base_file,
    ...
    std::cout << " width_u32=" << width_u32 << " ndims_64=" <<  ndims_64 << std::endl;
  ...
  int build_disk_index(const char *dataFilePath, const char *indexFilePath,
    ...
    std::cout << "build_disk_index begin dataFilePath=" << dataFilePath << " indexFilePath=" << indexFilePath << std::endl;
    std::cout << "indexBuildParameters =" << indexBuildParameters << std::endl;
    ...
    // train_size
    std::cout << "XXXXXXX data_file_to_use=" << data_file_to_use << std::endl;
